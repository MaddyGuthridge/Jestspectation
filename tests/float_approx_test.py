...
def test_magnitude():
    assert FloatApprox(0.2, magnitude=0.1) == 0.1


def test_magnitude_fail():
    assert FloatApprox(0.21, magnitude=0.1) != 0.1


def test_percent():
    assert FloatApprox(100, percent=10) == 110


def test_percent_fail():
    assert FloatApprox(100, percent=10) != 111
